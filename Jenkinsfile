            ...
            steps {
                script {
                    sshagent(credentials: ['3807b830-68b2-494e-a9bc-69d9a20c84d7']) {
                        ...
                        if (exists == 'exists') {
                            sh 'ssh -o StrictHostKeyChecking=no root@137.184.220.75 "cd /app/prueba-cicd-api && git pull"'
                        } else {
                            sh 'ssh -o StrictHostKeyChecking=no root@137.184.220.75 "git clone https://github.com/lnogales40/prueba-cicd-api.git /app/prueba-cicd-api"'
                        }
                    }
                }
            }
